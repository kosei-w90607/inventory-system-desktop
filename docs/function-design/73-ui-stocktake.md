...
SPEC-STK-TIME-D1 / D7〜D9。既存の検索/HID・候補確認・一覧・確定結果を維持し、数量入力の前に明示的な「今から数える」を置く。以下の旧UI-10-D2/D11の検索成功だけで数量入力へ進む動作は、新方式のruntime切替時に本節へ置き換える。
...
| 計数環境不成立 | 計数を開始できない理由と再起動/担当者への確認を示す。60分待つ、確認checkbox、時刻自己申告で解除しない |
