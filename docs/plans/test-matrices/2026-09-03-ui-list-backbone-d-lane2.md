...
| SC14a presence: history 固定列（DSR-22 mapping、history のみの例外） | `rg -n '<th class="id">記録日時</th><th class="id2">代表商品</th>\|<th class="id">日時</th><th class="id2">種別</th>' docs/design-system/reference/mockup-d-history.html \| wc -l` | 3（入出庫履歴 / 在庫変動履歴 / 操作ログ） | green |
