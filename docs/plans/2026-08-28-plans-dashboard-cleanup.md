...
- state-only 遷移 `human-confirm->ready-hosted-final` の根拠: owner Ready 承認 2026-08-28（本 lane 介入 2/3。Ready 遷移実行・merge・closeout を Coordinator へ委任）。exact HEAD の L1 full evidence と hosted run は PR body を正とする。
