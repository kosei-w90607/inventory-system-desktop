...
- Amendments: 69c6011cc410d14b16e2793c089f286cb960fd18, 25f705127a910a8346ae5d7a12179ece19504bec, 67be6db06eb6cb0a07e0a2083ad35f0570a74804, 7a3bfc1cf30c63f1c4c05e22057938c147985ca4
...
- **S4 `PriceRevisionFilters.tsx`**: 取引先 trigger wrapper `:62`（GA2 comment `:60-61` は「同じ wrapper に置いて群化」の趣旨を保ち、`grid gap-1` に更新）/ 表示件数 wrapper `:112` を `grid gap-1`、未参照の `id="price-revision-per-page-label"`（`:114`）を削除（`DepartmentFilter` の `labelId` と同型の死に id、Plan Review round 1 Opus P3-5）。Checkbox 2 site（`:102` / `:143`）に `self-center`（**GA3: `h-9 items-center self-end` へ**）。
