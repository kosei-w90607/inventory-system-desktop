...
| [01-decision-rules.md](01-decision-rules.md) | DSR-01〜24: 実装判断を一意に決めるルール集 | 主動線 CTA / Tabs vs SegmentedControl / Toast vs Alert 3 階層 / ステータスバッジ配置 / read-only vs disabled / 必須表示 / 確認ダイアログ境界 / semantic 色 / Form セクション / フィルタソース / 空状態・Tooltip / truncate・密度 / 表示スケール / ファイル選択方式 / returnTo 検証 / DSR-21 現在地と選択状態の色分離 / DSR-22 一覧の器・現在行・UI 部品枠のコントラスト / DSR-23 プルダウン統一 / DSR-24 追加導線を伴う master 参照の picker dialog 統一 |
