...
| [04-backbone.md](04-backbone.md) | 16 行の「まず守る骨」（00〜03 の上に被せる優先原則、owner 採用 2026-08-20 + wave 8 lane 1 拡張 2026-09-03）+ foundations 追記 token 表 + 00〜03 への反映先 | 文字 16px 最低線 / 色 3 家族 / badge 3 種 / primary 1 つ / PageShell / 検索欄 live 統一 / 押せる顔 / 1 行説明 / icon 3 段 / 待ち時間 / 密度維持 / 枠 2 段コントラスト / 一覧の器 / 現在行 3 点 / 低視力 L3。お手本 mockup と提案原文は [reference/](reference/README.md) |
