...
| [mockup-f-supplier-picker.html](mockup-f-supplier-picker.html) | 取引先ピッカー：一括価格改定・商品登録/修正・取引先管理、自動選択 A/B、dialog 重ねの overlay 比較 | 提案。6状態の静的 HTML、外部資源なし、合成データ。自動選択 A/B・入庫記録適用・取引先管理の見た目は owner 確認待ち |
