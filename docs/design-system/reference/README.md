...
mockup-c / mockup-d / mockup-e / mockup-f / mockup-g は同じ CSS（token）系統を基に作成しており、画面間でバラつかないこと自体を確認点にしている。mockup-f の表・scroll 箱・行・badge は mockup-d-lists を流用する。
