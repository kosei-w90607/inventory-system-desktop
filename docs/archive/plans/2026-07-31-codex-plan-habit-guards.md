...
- hosted = run 30636788316 success（exact-HEAD `adfc163`、owner 指示 dispatch。PR event 走行は changed-area classifier で skipped だったため explicit dispatch で充足）。merge = owner 委任で squash `111c7ed`。本 commit で archive 移動
