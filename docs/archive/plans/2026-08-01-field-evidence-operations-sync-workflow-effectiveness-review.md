...
対象: PR #55（squash merge `fc19daa4fe8d12ffb1b13a4c536bc566c32962be`、2026-08-01）。店舗調査で既に得ていたZ004/CV17証跡とowner補足を、実装済み・未実装・operator受入へ分離して正本化したR3 docs-only change。
