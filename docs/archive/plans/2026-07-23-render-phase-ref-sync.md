...
- State Narrative（2026-07-23）: 基準HEAD `ca741a5` で環境・active packet不在・P7b-1・
...
- State Narrative（2026-07-23、post-merge closeout）: ownerはmergeと後処理を承認
  ...
  （merge `062f6b8846a5844d9fbe74a5e06ce7c269cc7621`）。
...
基準HEAD: `ca741a5`。監査findingの旧lineはdrift済みであり、以下を実測した。
...
- detection/compatibility: `/tmp`へexact 7.1.1を
  ...
  HEAD `ca741a5`の全frontend sourceへ適用 -> targetは
