...
### 直近の作業状態
- **workflow docs WER consolidation**: public-writer branch `impl/workflow-docs-wer-consolidation` / active packet `docs/plans/2026-07-21-workflow-docs-wer-consolidation.md` / 次 action = Double Audit → Ready → merge
