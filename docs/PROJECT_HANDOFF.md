...
- Z004 parser は既存実装として維持するが、2026-07-06 issue #135で確認した`EcrDatas` layout Aには未対応で安全停止する。Z004自体は個数・金額を持つ確認済みPLU別売上で、BIZ-03在庫増減pipelineも実装済み。二形状対応・固定slot・段階導入・店舗採取shapeでのend-to-end再検証をgo-live前の別R3で扱う
