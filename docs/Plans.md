...
- **㉔ ホーム画面を mockup-c 案へ寄せる（R2、plan-gate）**: `plans/2026-09-16-home-mockup-c-runtime.md`。branch `agent/home-mockup-c-runtime`、Plan Commit pending。owner 決定 2026-09-11（mockup-c 採用、補助文言は状態の説明、前日分未取込み alert は不変）。wave 11 lane 1。
