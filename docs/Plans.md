...
1. 型生成の失敗検出（小変更、[backlog](backlog.md#やると決めたもの順番未定)「型生成の失敗が成功扱いになる」entry）。**着手中（2026-09-22、implementing）**: [Plan Packet](plans/2026-09-22-bindings-export-failure-detection.md)、R3（Gated Amendment 2 で R2 から引上げ）、Writer = Sonnet subagent / Plan Reviewer = Sonnet / Final Reviewer = Codex + Opus（Double Audit）。
