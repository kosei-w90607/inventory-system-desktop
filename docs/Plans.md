...
- **マージ検証整理（R3、implementing）**: [Plan Packet](plans/2026-09-14-merge-evidence-simplification.md) / [Matrix](plans/test-matrices/2026-09-14-merge-evidence-simplification.md)。独立Plan ReviewはP1/P2=0。ownerがAstra xhighの単独実装、Sonnet / Opusの独立監査、GA1と累計介入上限8回案を承認。GA1を確定して単独実装へ進む。設定有効化は具体的payloadの完成・検証後。
